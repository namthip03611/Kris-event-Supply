...
export default function Header({
  ...
  return (
    <header className="sticky top-0 z-50 bg-[#0A0A0A]/90 backdrop-blur-md border-b border-white/10 text-white">
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <button
              ...
              className="flex items-center space-x-1.5 px-3 py-1.5 rounded-lg border border-white/10 hover:border-white/30 text-[10px] font-bold uppercase tracking-widest text-neutral-300 hover:text-white transition-all bg-black/40"
            ...
            <button
              ...
              className="flex items-center space-x-1.5 px-5 py-2.5 rounded-lg text-xs font-black uppercase tracking-widest text-white bg-accent hover:bg-accent-hover shadow-lg shadow-accent/15 transition-all cursor-pointer transform hover:-translate-y-0.5 active:translate-y-0"
              id="btn-nav-quote"
            >
          ...
          <div className="md:hidden flex items-center space-x-3">
            <button
              onClick={toggleLanguage}
              className="flex items-center space-x-1 px-2.5 py-1.5 rounded-lg border border-white/10 text-xs font-bold text-neutral-300 bg-black/40"
            ...
            <div className="px-2 pt-2 pb-6 space-y-1 sm:px-3">
              ...
              <div className="pt-4 pb-2 border-t border-white/10 px-4">
                <button
                  ...
                  className="flex w-full items-center justify-center space-x-2 px-4 py-3 rounded-lg text-xs font-black uppercase tracking-widest text-white bg-accent hover:bg-accent-hover shadow-md"
