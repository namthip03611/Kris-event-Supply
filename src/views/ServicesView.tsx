...
export default function ServicesView({
  ...
  return (
    <div id="services-view-container" className="bg-off-white text-charcoal">
      {/* 1. Page Hero */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <h1 className="font-display text-4xl sm:text-6xl lg:text-7xl font-black uppercase tracking-tight max-w-5xl mx-auto text-navy leading-[0.85] drop-shadow-sm">
              ...
              <span className="block outline-text-gold-thick my-2">{currentLanguage === 'th' ? 'บุคลากรและสตาฟอีเวนต์' : 'FOR LIVE ACTIVATIONS'}</span>
              ...
              return (
                ...
                >
                  ...
                  <div className={`lg:col-span-7 space-y-6 ${index % 2 === 1 ? 'lg:order-2' : ''}`}>
                    ...
                    <h2 className="font-display text-2xl sm:text-3xl font-black text-navy uppercase tracking-tight">
                      {spec.title}
                    </h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-neutral-200/60">
                      {spec.bullets.map((bullet, bIdx) => (
                        <div key={bIdx} className="flex items-start space-x-3 text-xs sm:text-sm text-charcoal">
                  ...
                  <div className={`lg:col-span-5 relative ${index % 2 === 1 ? 'lg:order-1' : ''}`}>
                    ...
                    <div className="relative bg-off-white border border-neutral-200/60 rounded-lg p-8 shadow-sm min-h-[250px] flex flex-col justify-between hover:border-accent transition-all duration-300">
                      <div className="flex justify-between items-start">
                        <span className="text-[9px] font-mono text-neutral-400 tracking-widest uppercase font-bold">
                      ...
                      <div className="space-y-3 my-8">
                        ...
                        <h4 className="font-display text-lg font-bold text-navy leading-tight uppercase tracking-wide">
                          {currentLanguage === 'th' 
      ...
      <section className="py-24 bg-off-white border-b border-neutral-200/60" id="pricing-tool-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section className="py-24 bg-white border-b border-neutral-200/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-lg bg-off-white border border-neutral-200/60 flex flex-col justify-between hover:border-accent transition-all shadow-sm">
              <div>
                <span className="text-xs font-black text-accent font-mono block tracking-widest">STAGE 01</span>
                <h3 className="font-display text-lg font-bold text-navy mt-4 mb-3 uppercase tracking-wide">
      ...
      {/* 5. CTA Section */}
      <section className="py-24 bg-navy text-white border-t border-white/10 text-center relative overflow-hidden" id="services-cta">
