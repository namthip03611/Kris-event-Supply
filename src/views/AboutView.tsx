...
export default function AboutView({ currentLanguage }: AboutViewProps) {
  ...
  return (
    <div id="about-view-container" className="bg-off-white text-charcoal">
      {/* 1. Page Header / Hero */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <h1 className="font-display text-4xl sm:text-6xl lg:text-7xl font-black uppercase tracking-tight max-w-5xl mx-auto text-navy leading-[0.85] drop-shadow-sm">
              ...
              <span className="block outline-text-gold-thick my-2">{currentLanguage === 'th' ? 'ทีมงานที่ไร้รอยต่อ' : 'FIELD OPERATIONS'}</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-6">
              {VALUES_DATA.map((value) => {
                ...
                return (
                  <div
                    key={value.id}
                    className="p-6 rounded-lg border border-neutral-200/60 bg-off-white flex flex-col justify-between hover:border-accent transition-all shadow-sm"
                  >
                    <div>
                      ...
                      <h3 className="font-display text-base font-bold text-navy mb-2.5 uppercase tracking-wide">
            ...
            <div className="lg:col-span-5 relative flex flex-col justify-between">
              ...
              <div className="relative bg-off-white border border-neutral-200/60 rounded-lg overflow-hidden flex-1 flex flex-col shadow-sm">
                <div className="h-60 sm:h-72 overflow-hidden relative">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-off-white via-off-white/10 to-transparent" />
                </div>
                <div className="p-6 sm:p-8 flex-1 flex flex-col justify-center">
                  ...
                  <h3 className="font-display text-lg font-bold text-navy mt-2 uppercase tracking-wide">
                    {currentLanguage === 'th' ? 'ความยืดหยุ่นในการปฏิบัติงานสูงสุด' : 'Maximum Operational Agility'}
                  </h3>
                  <p className="text-xs text-charcoal mt-2.5 leading-relaxed">
                    {currentLanguage === 'th'
      ...
      <section className="py-24 bg-off-white border-b border-neutral-200/60" id="sourcing-process">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-20">
            <span className="text-[10px] font-bold text-accent uppercase tracking-widest font-mono">
              The Blueprint
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {steps.map((step, index) => (
              <div
                key={step.num}
                className="relative p-8 rounded-lg bg-white border border-neutral-200/60 hover:border-accent transition-all flex flex-col justify-between shadow-sm"
              >
                <div>
                  <div className="flex justify-between items-center mb-6">
                    ...
                    {index < 5 && (
                      <span className="hidden lg:block text-neutral-300 text-lg font-mono">
                        →
                      </span>
                    )}
                  </div>
                  <h3 className="font-display text-base font-bold text-navy mb-3 uppercase tracking-wide">
                    {step.title}
                  </h3>
                  <p className="text-xs text-charcoal leading-relaxed">
                    {step.desc}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-5 relative">
              ...
              <div className="relative rounded-lg overflow-hidden aspect-[4/5] bg-off-white border border-neutral-200/60 shadow-xl">
                <img
                ...
                />
                {/* Badge top-right */}
                <div className="absolute top-4 right-4 bg-accent text-navy font-semibold px-3 py-1.5 rounded-sm text-[10px] font-mono border border-white/10 shadow-md uppercase tracking-wider">
                  {t.missionBadge}
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 space-y-8">
              <div className="space-y-4">
                <span className="text-[10px] font-bold text-accent uppercase tracking-widest font-mono bg-accent/5 px-3 py-1 rounded-md">
                  {currentLanguage === 'th' ? 'พันธกิจและวิสัยทัศน์' : 'MISSION & VISION'}
                </span>
                <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-black text-navy uppercase tracking-tight leading-none">
                  {currentLanguage === 'th' ? 'สร้างคุณค่าให้กับทุกหน้างาน' : 'Creating Value For Every Field Activation'}
                </h2>
                <p className="font-sans text-charcoal text-sm sm:text-base leading-relaxed">
                  {t.missionDesc1}
                </p>
                <p className="font-sans text-charcoal text-xs sm:text-sm leading-relaxed">
                  {currentLanguage === 'th'
              ...
              <div className="border-l-4 border-accent pl-6 space-y-3 py-1 bg-accent/[0.02] rounded-r-lg pr-4">
                ...
                <p className="text-sm font-medium italic text-navy leading-relaxed font-display">
                  {t.missionQuote}
                </p>
                <span className="text-[10px] text-charcoal uppercase tracking-widest block font-mono">
